...
//		Jugadores jugadores=new Jugadores();
		...
		jugadores.agregarJugador(new Jugador("Guzman",Posicion.Arquero,7,"Perez"));
		
		jugadores.agregarJugador(new Jugador("Mascherano",Posicion.Defensor,5,"Salvio"));
		jugadores.agregarJugador(new Jugador("Fazio",Posicion.Defensor,2,"Rigoni"));
		jugadores.agregarJugador(new Jugador("Mercado",Posicion.Defensor,7,"Mercado"));
		jugadores.agregarJugador(new Jugador("Otamendi",Posicion.Defensor,6,"Jugador2"));
		jugadores.agregarJugador(new Jugador("Pezzela",Posicion.Defensor,8,"Jugador2"));
		jugadores.agregarJugador(new Jugador("Insua",Posicion.Defensor,3,"Jugador2"));
		
		jugadores.agregarJugador(new Jugador("Salvio",Posicion.Mediocampista,4,"Icardi"));
		jugadores.agregarJugador(new Jugador("Banega",Posicion.Mediocampista,2,"Jugador2"));
		jugadores.agregarJugador(new Jugador("Acuna",Posicion.Mediocampista,8,"Messi"));
		...
		jugadores.agregarJugador(new Jugador("Perotti",Posicion.Mediocampista,5,"Jugador2"));
		jugadores.agregarJugador(new Jugador("Belluschi",Posicion.Mediocampista,5,"Jugador2"));
		jugadores.agregarJugador(new Jugador("Perez",Posicion.Mediocampista,6,"Jugador2"));
		
		jugadores.agregarJugador(new Jugador("Messi",Posicion.Delantero,7,"Jugador2"));
		jugadores.agregarJugador(new Jugador("Icardi",Posicion.Delantero,6,"Jugador2"));
		jugadores.agregarJugador(new Jugador("Di Maria",Posicion.Delantero,5,"Jugador2"));
		jugadores.agregarJugador(new Jugador("Dybala",Posicion.Delantero,4,"Perez"));
		jugadores.agregarJugador(new Jugador("Benedetto",Posicion.Delantero,3,"Pavon"));
		jugadores.agregarJugador(new Jugador("Pavon",Posicion.Delantero,7,"Aguero"));
		jugadores.agregarJugador(new Jugador("Aguero",Posicion.Delantero,5,"Di Maria"));
...
//	System.out.println(optima);
//	System.out.println();
//	System.out.println(solver.nivelDeJuegoTotal(optima));
//	}
}
